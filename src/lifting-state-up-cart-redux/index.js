...
import DanhSachSanPham from "./listProduct";
import Modal from "./modal";
import {connect} from "react-redux";
class LiftingStateUpCartRedux extends Component {
  
  render() {
    let {detailProduct, mangSanPham} = this.props;
    return (
      <div>
...
const mapStateToProps = (state) => {
    return {
      mangSanPham: state.userReducer.mangSanPham,
      detailProduct: state.userReducer.detailProduct
    }
}
